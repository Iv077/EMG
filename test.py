...
emg_filtered = sp.signal.filtfilt(b1, a1, raw, axis=0)
...
ads = np.sum(np.abs(np.diff(emg_envelope,axis=0)),axis=0)
...
#print('Classification score WITHOUT PCA:', score*100, '%')


file = 'EMG_Classifier3.sav'
